...
| 30 | R030_INQ_POLICY | service_or_information_inquiry AND inquiry_answer_source == kb_policy (pre-RAG candidate) | draft_reply_with_rag |
| 30 | R030A_INQ_POLICY_ANSWERABLE | kb_policy inquiry AND kb_answerable is True (post-RAG) | draft_reply_with_rag |
| 30 | R030B_INQ_POLICY_UNANSWERABLE | kb_policy inquiry AND kb_answerable is False (post-RAG) | escalate_to_reservations_team |
| 31 | R031_INQ_WITHDRAWAL | service_or_information_inquiry AND request_type == withdrawal_or_acknowledgment | audit_only_with_note |
| 32 | R032_INQ_DEFAULT | service_or_information_inquiry (inquiry_answer_source not kb_policy, not a withdrawal) | escalate_to_reservations_team |
